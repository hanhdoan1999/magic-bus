...
<jsp:param value="Magic Bus-Màn hình danh sách tuyến theo ID bus" name="title_for_header_jsp"/>
</jsp:include>
<style>
label.error {
        font-weight: 200;
...
<div class="container">
<h3>DANH SÁCH TUYẾN ĐƯỜNG <span style="color: red">(ID Bus: <c:out value="${param.idBus}"/>)</span></h3>
<a href="xoabus?idBus=<c:out value="${param.idBus}"/>" class="btn btn-danger" role="button" style="margin-bottom: 25px">TRỞ VỀ</a>
